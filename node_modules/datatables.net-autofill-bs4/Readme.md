# AutoFill for DataTables with styling for [Bootstrap 4](http://getbootstrap.com/)

This package contains distribution files required to style [AutoFill extension](https://datatables.net/extensions/autofill) for [DataTables](https://datatables.net/) with styling for [Bootstrap 4](http://getbootstrap.com/).
